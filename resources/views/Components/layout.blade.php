          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                <span class="absolute -inset-1.5"></span>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhkx1okniC2nE0BKoEo6j7XAff3LMrjscXVPtSDndNrlQwa8IwdGnJfDlFziJkTvSrOv4&usqp=CAU" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
              </button>
  ...
  <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      ...
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhkx1okniC2nE0BKoEo6j7XAff3LMrjscXVPtSDndNrlQwa8IwdGnJfDlFziJkTvSrOv4&usqp=CAU" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Cat in business</div>
            <div class="text-sm font-medium text-gray-400">Catbusiness@yahoo.com</div>
          </div>
